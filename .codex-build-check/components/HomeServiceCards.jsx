...
const cardVariants = [
  {
    ...
    selected: "border-transparent bg-gradient-to-br from-[#2563eb] to-[#1d4ed8] text-white shadow-[0_22px_48px_rgba(37,99,235,0.22)]",
    overlay: "bg-gradient-to-br from-[#dbeafe] via-transparent to-transparent"
  },
  {
    gradient: "linear-gradient(135deg,#f97316 0%,#ea580c 100%)",
    shadow: "0 22px 48px rgba(249, 115, 22, 0.24)",
    selected: "border-transparent bg-gradient-to-br from-[#f97316] to-[#ea580c] text-white shadow-[0_22px_48px_rgba(249,115,22,0.24)]",
    overlay: "bg-gradient-to-br from-[#ffedd5] via-transparent to-transparent"
  },
  {
    gradient: "linear-gradient(135deg,#22c55e 0%,#16a34a 100%)",
    shadow: "0 22px 48px rgba(34, 197, 94, 0.24)",
    selected: "border-transparent bg-gradient-to-br from-[#22c55e] to-[#16a34a] text-white shadow-[0_22px_48px_rgba(34,197,94,0.24)]",
    overlay: "bg-gradient-to-br from-[#dcfce7] via-transparent to-transparent"
  },
  {
    gradient: "linear-gradient(135deg,#14b8a6 0%,#0f766e 100%)",
    shadow: "0 22px 48px rgba(20, 184, 166, 0.24)",
    selected: "border-transparent bg-gradient-to-br from-[#14b8a6] to-[#0f766e] text-white shadow-[0_22px_48px_rgba(20,184,166,0.24)]",
