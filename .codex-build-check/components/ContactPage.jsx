        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          ...
          <div className="space-y-4">
            {miniFaqs.map((item, index) => (
              <details
                key={item.question}
                className="group relative mx-auto w-full max-w-[90%] rounded-xl border border-gray-200 bg-white p-4 transition-all duration-300 hover:border-green-500 hover:shadow-sm active:scale-[0.98] md:max-w-none md:rounded-2xl md:p-5"
