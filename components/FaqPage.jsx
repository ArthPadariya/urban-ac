            ...
            <div className="space-y-4 motion-safe:animate-[locationsFadeUp_0.8s_ease-out_both]">
              {activeItems.map((item) => {
                ...
                return (
                  <div
                    key={item.question}
                    className="group overflow-hidden rounded-2xl border border-[#eee] bg-white shadow-[0_8px_22px_rgba(15,23,42,0.05)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_38px_rgba(15,23,42,0.1)]"
                  >
                    <button
                      type="button"
                    ...
                    >
                      <div className="overflow-hidden">
                        <div className="border-t border-[#f1f1f1] px-5 pb-5 pt-4 text-sm leading-7 text-[#666]">
                          {item.answer}
                        </div>
                      </div>
                    </div>
