...
export const citySlug = "vadodara";
...
export const services = [
  {
    ...
    includes: [
      ...
      "fan motor and capacitor testing",
      "compressor and sensor review"
    ],
    problems: [
      "AC not cooling properly",
      "water leakage from the indoor unit",
      "unusual vibration or noise",
      "compressor or electrical starting issues"
    ],
    benefits: [
      "restore dependable cooling",
      "reduce the risk of bigger breakdowns",
      "avoid unnecessary electricity waste",
      "improve daily comfort during peak heat"
    ],
  ...
  },
  {
    ...
    benefits: [
      ...
      "reduce power consumption pressure",
      "help prevent future breakdowns"
    ],
    types: ["Split AC Service", "Window AC Service", "AC Performance Check", "Preventive Cleaning Visit"],
    localAngles: [
  ...
  },
  {
    ...
    keyword: "AC installation in Vadodara",
    shortDescription:
    ...
    includes: [
      ...
      "copper and wiring connection review",
      "final cooling and safety testing"
    ],
    problems: [
      "poor cooling after installation",
      "water leakage from wrong slope",
      "unstable mounting or vibration",
      "setup mistakes that reduce efficiency"
    ],
    benefits: [
      "improve first-day cooling performance",
      "reduce future service issues from bad fitting",
      "support cleaner drainage and airflow",
      "protect the unit during long-term use"
    ],
    types: ["Split AC Installation", "Window AC Installation", "AC Reinstallation", "AC Shifting Support"],
    localAngles: [
  ...
  },
  {
    ...
    includes: [
      ...
      "correct refrigerant refilling",
      "cooling output verification"
    ],
    problems: [
      "low cooling despite long runtime",
      "ice formation on coils",
      "pressure imbalance symptoms",
      "warm air from the indoor unit"
    ],
    benefits: [
      "restore faster cooling",
      "protect the compressor from added stress",
      "improve efficiency during heavy use",
      "help catch leakage before repeat gas loss"
    ],
    types: ["Split AC Gas Filling", "Window AC Gas Filling", "R32 Filling", "R410A Pressure Refill"],
    localAngles: [
  ...
  },
  {
    ...
    name: "AC Maintenance (AMC)",
    sentence: "AC maintenance AMC service",
    keyword: "AC maintenance AMC in Vadodara",
    shortDescription:
    ...
    problems: [
      ...
      "repeat faults due to irregular maintenance",
      "unexpected summer breakdowns",
      "rising operating cost from neglected units"
    ],
    benefits: [
      "keep ACs in better yearly condition",
      "reduce emergency repair surprises",
      "support more efficient performance",
      "simplify maintenance planning"
    ],
    types: ["Home AMC Plan", "Office AMC Plan", "Periodic AC Maintenance", "Priority Seasonal Support"],
    localAngles: [
  ...
  },
  {
    ...
    keyword: "split AC repair in Vadodara",
    shortDescription:
    ...
    includes: [
      ...
      "cooling and drainage review",
      "electrical fault tracing"
    ],
    problems: [
      "split AC cooling loss",
      "indoor leakage and drainage faults",
      "sensor or communication problems",
      "outdoor unit malfunction"
    ],
    benefits: [
      "restore balanced split AC cooling",
      "reduce repeat leakage or fault calls",
      "improve day-to-day system stability",
      "extend useful life of the unit"
    ],
    types: ["Indoor Unit Repair", "Outdoor Unit Repair", "Sensor Fault Repair", "Split AC Leakage Repair"],
    localAngles: [
  ...
  },
  {
    slug: "ac-pcb-repair",
    name: "AC PCB Repair",
    sentence: "AC PCB repair",
    keyword: "AC PCB repair in Vadodara",
    shortDescription:
    ...
    includes: [
      ...
      "voltage damage review",
      "safe board-level repair guidance"
    ],
    problems: [
      "error code issues",
      "AC not responding to commands",
      "voltage-related board faults",
      "unpredictable on-off behavior"
    ],
    benefits: [
      "restore control accuracy",
      "avoid unnecessary full-unit replacement",
      "extend the service life of the AC",
      "improve operating safety and stability"
    ],
    types: ["Inverter PCB Repair", "Sensor Circuit Repair", "Relay & Voltage Fault Work", "Board Diagnosis Visit"],
    localAngles: [
  ...
  },
  {
    ...
    sentence: "AC cleaning service",
    keyword: "AC cleaning service in Vadodara",
    shortDescription:
    ...
    includes: [
      ...
      "drainage cleaning",
      "deep dust and odor removal"
    ],
    problems: [
      "bad odor from the AC",
      "reduced airflow from dust buildup",
      "dirty filters affecting air quality",
      "slow cooling caused by clogged components"
    ],
    benefits: [
      "improve indoor air quality",
      "support stronger cooling output",
      "reduce electricity consumption pressure",
      "help prevent hygiene-related AC complaints"
    ],
    types: ["Split AC Cleaning", "Window AC Cleaning", "Deep Coil Cleaning", "Drain & Blower Cleaning"],
    localAngles: [
...
export const locations = [
  {
    ...
    context: "family apartments, gated communities, and regular household AC usage",
    nearby: ["akota", "old-padra-road", "gotri", "gorwa", "subhanpura"]
  },
  {
    slug: "sama",
    name: "Sama",
    responseTime: "30-45 minutes",
    landmark: "Sama-Savli Road housing",
    context: "independent homes, new residential blocks, and mixed-use neighborhoods",
    nearby: ["harni", "new-vip-road", "chhani", "fatehgunj", "nizampura"]
  },
  {
    slug: "alkapuri",
    name: "Alkapuri",
    ...
    context: "premium residences, offices, showrooms, and central business traffic",
    nearby: ["akota", "old-padra-road", "sayajigunj", "fatehgunj", "gorwa"]
  },
  {
    slug: "gotri",
    name: "Gotri",
    responseTime: "30-45 minutes",
    landmark: "Gotri Road townships",
    context: "large residential clusters, clinics, and expanding west-side communities",
    nearby: ["subhanpura", "gorwa", "vasna", "akota", "old-padra-road"]
  },
  {
    slug: "manjalpur",
    name: "Manjalpur",
    responseTime: "35-50 minutes",
    landmark: "Manjalpur main road",
    context: "older neighborhoods, local markets, and heavy daily family usage",
    nearby: ["makarpura", "tarsali", "waghodia-road", "ajwa-road", "akota"]
  },
  {
    slug: "karelibaug",
    name: "Karelibaug",
    responseTime: "30-45 minutes",
    landmark: "Karelibaug main road colonies",
    context: "dense housing, inner roads, and established residential pockets",
    nearby: ["nizampura", "fatehgunj", "harni", "ajwa-road", "waghodia-road"]
  },
  {
    slug: "nizampura",
    name: "Nizampura",
    responseTime: "25-40 minutes",
    landmark: "Nizampura junction apartments",
    context: "apartment blocks, mixed-use roads, and family homes needing quick support",
    nearby: ["karelibaug", "subhanpura", "fatehgunj", "chhani", "gorwa"]
  },
  {
    slug: "waghodia-road",
    name: "Waghodia Road",
    responseTime: "35-50 minutes",
    landmark: "Waghodia Road societies",
    context: "long residential stretches, townships, and spread-out local demand",
    nearby: ["ajwa-road", "karelibaug", "manjalpur", "tarsali", "harni"]
  },
  {
    slug: "ajwa-road",
    name: "Ajwa Road",
    responseTime: "35-50 minutes",
    landmark: "Ajwa Road housing belt",
    context: "growing neighborhoods, family housing, and road-facing properties",
    nearby: ["waghodia-road", "karelibaug", "harni", "manjalpur", "tarsali"]
  },
  {
    slug: "makarpura",
    name: "Makarpura",
    responseTime: "35-50 minutes",
    landmark: "Makarpura GIDC and housing side",
    context: "industrial offices, staff quarters, and nearby residential use",
    nearby: ["tarsali", "manjalpur", "gorwa", "akota", "old-padra-road"]
  },
  {
    slug: "tarsali",
    name: "Tarsali",
    responseTime: "35-50 minutes",
    landmark: "Tarsali ring road neighborhoods",
    context: "residential stretches, roadside businesses, and mid-city connectivity",
    nearby: ["makarpura", "manjalpur", "waghodia-road", "ajwa-road", "akota"]
  },
  {
    slug: "harni",
    name: "Harni",
    responseTime: "30-45 minutes",
    landmark: "Airport Road and Harni side",
    context: "newer housing pockets, airport-side roads, and steady family demand",
    nearby: ["sama", "new-vip-road", "chhani", "karelibaug", "ajwa-road"]
  },
  {
    slug: "chhani",
    name: "Chhani",
    responseTime: "30-45 minutes",
    landmark: "Chhani Jakat Naka belt",
    context: "residential stretches, small businesses, and north-side road access",
    nearby: ["sama", "harni", "new-vip-road", "nizampura", "fatehgunj"]
  },
  {
    slug: "subhanpura",
    name: "Subhanpura",
    responseTime: "25-40 minutes",
    landmark: "Subhanpura residential roads",
    context: "apartment clusters, schoolside housing, and reliable family cooling demand",
    nearby: ["gotri", "nizampura", "gorwa", "vasna", "fatehgunj"]
  },
  {
    slug: "fatehgunj",
    name: "Fatehgunj",
    responseTime: "25-40 minutes",
    landmark: "MS University side",
    context: "student housing, offices, and active mixed-use central city movement",
    nearby: ["sayajigunj", "alkapuri", "nizampura", "sama", "chhani"]
  },
  {
    slug: "akota",
    name: "Akota",
    responseTime: "20-35 minutes",
    landmark: "Akota Stadium and Old Padra Road",
    context: "premium apartments, offices, and residential towers with heavy AC use",
    nearby: ["old-padra-road", "alkapuri", "vasna", "gorwa", "manjalpur"]
  },
  {
    slug: "old-padra-road",
    name: "Old Padra Road",
    responseTime: "20-35 minutes",
    landmark: "Old Padra Road commercial-residential stretch",
    context: "showrooms, apartment blocks, and premium residential service demand",
    nearby: ["akota", "alkapuri", "vasna", "gorwa", "sayajigunj"]
  },
  {
    slug: "new-vip-road",
    name: "New VIP Road",
    responseTime: "25-40 minutes",
    landmark: "New VIP Road housing clusters",
    context: "new projects, apartment communities, and high daily cooling usage",
    nearby: ["sama", "harni", "chhani", "ajwa-road", "karelibaug"]
  },
  {
    slug: "gorwa",
    name: "Gorwa",
    responseTime: "25-40 minutes",
    landmark: "Gorwa industrial and residential side",
    context: "industrial offices, residential blocks, and mixed-use service demand",
    nearby: ["subhanpura", "alkapuri", "gotri", "akota", "makarpura"]
  },
  {
    slug: "sayajigunj",
    name: "Sayajigunj",
    responseTime: "20-35 minutes",
    landmark: "Vadodara Junction business belt",
    context: "commercial buildings, offices, and central transport-side activity",
    nearby: ["fatehgunj", "alkapuri", "old-padra-road", "gorwa", "akota"]
  }
];

export const topLocations = ["vasna", "alkapuri", "akota", "gotri", "sama", "sayajigunj"];
...
const cityServiceSlugMap = Object.fromEntries(
  services.map((service) => [`${service.slug}-${citySlug}`, service])
);
...
const cityFaqTemplates = [
  ...
  (service) => ({
    ...
    answer: `Yes. We provide ${service.sentence} for homes, offices, clinics, shops, and other commercial spaces across major areas of ${business.city}.`
  }),
  (service) => ({
    question: `Do you only cover central Vadodara for ${service.sentence}?`,
    answer: `No. The city page links multiple coverage areas, and ${business.name} serves major residential and commercial zones across Vadodara with local route planning.`
  }),
  (service) => ({
...
const locationFaqTemplates = [
  ...
  (service, location) => ({
    ...
    answer: `Use the call or WhatsApp CTA on this page, mention ${location.name} and the AC issue, and we will schedule the nearest available slot for local support.`
  })
];
...
const ctaTemplates = [
  ...
  (service, locationName) => ({
    ...
    text: `Use WhatsApp for quick booking or call now to confirm the next available slot for your AC type and issue.`
  }),
  (service, locationName) => ({
  ...
  (service, locationName) => ({
    ...
    text: `Share your location, unit type, and problem by call or WhatsApp, and our team will route your request to the right local technician.`
  }),
  (service, locationName) => ({
...
function getSeed(serviceSlug, locationSlug = citySlug) {
  return hashString(`${serviceSlug}-${locationSlug}`);
}
...
export function getMainServiceHref(serviceSlug) {
  return `/${serviceSlug}-${citySlug}`;
}

export function getEntryLocationHref(serviceSlug, locationSlug) {
  return `/${serviceSlug}-${locationSlug}`;
}

export function getRelatedServices(serviceSlug, locationSlug) {
  const seed = getSeed(serviceSlug, locationSlug ?? citySlug);
  const related = services.filter((service) => service.slug !== serviceSlug);

  return pickMany(related, seed, 3).map((service) => ({
    ...service,
    href: locationSlug ? getEntryLocationHref(service.slug, locationSlug) : getMainServiceHref(service.slug)
  }));
}

export function getCityIntro(service) {
  const seed = getSeed(service.slug);
  return pickFrom(cityIntroTemplates, seed)(service);
}

export function getLocationIntro(service, location) {
  const seed = getSeed(service.slug, location.slug);
  return pickFrom(locationIntroTemplates, seed)(service, location);
}
...
export function getCityFaqs(service) {
  const seed = getSeed(service.slug);
  return pickMany(cityFaqTemplates, seed, 3).map((builder) => builder(service));
}

export function getAreaFaqs(service, location) {
  const seed = getSeed(service.slug, location.slug);
  return pickMany(locationFaqTemplates, seed, 3).map((builder) => builder(service, location));
}
...
export function getCtaContent(service, location = null) {
  const seed = getSeed(service.slug, location?.slug ?? citySlug);
  return pickFrom(ctaTemplates, seed)(service, location?.name);
}
